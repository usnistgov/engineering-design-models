...
! use_file_open_utility YES 
tol_display NO 
!===========using the new user interface for release 18:
!menu_dialog NO
!oldstyle_menus YES
!  option for smt_fabrication:
!use_smmp_creation  YES
!  =======================================================
!   -------RELEASE 19-------------------- 
SMT_MFG_FABRICATION    YES
!TOOLBAR:
!new_dialog_ui_temp yes
