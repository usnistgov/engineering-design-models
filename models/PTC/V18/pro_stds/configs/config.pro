...
! Modified: Dec. 19, 1995 Rev 16, G. Leonard 
! Modified: July 25, 1997 Rev 18, C. Layne 
...
! 
! The following 2 settings are typically the same 
...
! 
! The following mapkeys are for the menudef.pro setbutton "DEFINE VIEWS". 
! 
...
MAPKEY tl #modify;#text; 
MAPKEY tf #modify;#text;#full note; 
MAPKEY ts #modify;#text;#text style; 
MAPKEY sn #sheets;#next;tssnspsrsn 
