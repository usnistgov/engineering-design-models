...
ECAD_BOARD_CSYS_DEF_NAME ecad_comp 
ECAD_COMP_CSYS_DEF_NAME ec_def 
ECAD_CREATE_HINT_ADD YES 
search_path ./ptc_comp 
search_path ./drawing 
search_path ./sheet_metal 
...
!======================================================== 
! Cabling demo specific 
!======================================================== 
! 
FULL_HLR_FOR_CABLES NONE 
! 
mapkey a1 #View;#Cosmetic;#Shade;#Restore;vcr;#Done-Return 
mapkey a2 #View;#Cosmetic;#Shade;#Restore;side2;#Done-Return 
mapkey a3 #View;#Cosmetic;#Shade;#Restore;side1;#Done-Return 

mapkey z1 %nr;#main;#Done-Return 
mapkey z2 %nr;#default;#Done-Return 

mapkey tc #environment;#thick cables;#done-return 
mapkey cl #environment;#center line;#done-return 
! 
mapkey shade #misc;#trail;cabdia16shd 
mapkey end #misc;#trail;end 
mapkey setup #misc;#trail;setup 
mapkey dgm #misc;#trail;dgm 
mapkey cab #misc;#trail;cab 
mapkey har #done/return;#applications;#cabling;#harness;#tuning; 
mapkey re1 #done/return;#regenerate;#environment;#thick cables; 
mapkey re2 #disp csys;#done-return; 
mapkey mb %re1;re2; 
mapkey scr #view;#names;#screw_holder; 
mapkey i1 #done/return;#view;#names;#main;#done-return; 
mapkey i2 #simplfd rep;#set current;#Master Rep;#done; 
mapkey intf %i1;%i2;#view;layer disp;#cover;#done sel;#names;#screw_holder; 
mapkey re3 #done/return;#view;#layer disp;#cover;#done sel;#done-return; 
mapkey ra #regenerate;#automatic; 
mapkey mc %re3;%ra; 
mapkey mfg #misc;#trail;mfg 
mapkey dw1 #misc;#trail;drw1 
mapkey dw2 #misc;#trail;drw2 
mapkey cca #connector;#assemble all 
mapkey ecad #mode;#assembly;#search/retr;#video_aft_board.asm 
mapkey dim #detail;#create;#dimension 

mapkey info #info;#measure;#clear/intf 
mapkey path #info;#cable info;#path;#sel by menu;#tuning.prt 
mapkey shd %tc;%sd;#view;#names; 

mapkey tt0 #retrieve;?;#/diagram;#dia_wirelist95.tbl 
mapkey tt1 #retrieve;?;#/drawing;#cab_connbom95.tbl 
mapkey tt2 #retrieve;?;#/drawing;#cab_pinout95.tbl 
mapkey tt3 #retrieve;?;#/drawing;#cab_spoolbom95.tbl 
mapkey tt4 %harness;#retrieve;?;#/drawing;#cab_wirelist95.tbl 
mapkey harness #done/return;#set model;#tuning;#table;#save/retrieve 
mapkey sw #sheets;#switch sheet;#switch items;#draft items;#pick; 
mapkey sp #sheets;#previous;#design;#move; 
mapkey laym #layer;#set items;#motor;#done sel;#add items 
mapkey layt #layer;#set items;#tune;#done sel;#add items 
