...
! Settings for reel demo 95-96 
!========================================================= 
!= Demo Specific Options == 
!========================================================= 
drawing_setup_file bcb.dtl 
...
SEARCH_PATH ./areel/misc 
SEARCH_PATH ./areel/assembly 
SEARCH_PATH ./areel/mfg 
SEARCH_PATH ./areel/parts 
SEARCH_PATH ./areel/Library_Parts/bailwires
SEARCH_PATH ./areel/Library_Parts/rotors
SEARCH_PATH ./areel/Library_Parts/screws
SEARCH_PATH ./areel/Library_Parts/spools
SEARCH_PATH ./areel/Library_Parts/washers

PRO_FORMAT_DIR ./areel/misc 
PRO_MF_PARAM_DIR ./areel/mfg 
PRO_MF_TPRM_DIR ./areel/mfg
PRO_GROUP_DIR ./areel/udf
...
mapkey a1 #View;#Cosmetic;#Shade 
mapkey a5 #Restore;reel_house 
mapkey a4 #Restore;reel_exp 
mapkey a3 #Restore;reel_trns_b 
mapkey a2 #Restore;reel_comp

mapkey dxs #Done/return;#Modify;#Xhatching 
mapkey rdxs #Done sel;#Spacing;#Half;#Half;#Half;#Done 
mapkey ly #layer;#top level;#create;vol;;#set items;#select all;#done sel 
...
LANDSCAPE_POSTSCRIPT_PRINT yes 
...
MAPKEY sv #view;#sketch view;#done-return; 
!========================================================= 
!== DISPLAY == 
!========================================================= 
