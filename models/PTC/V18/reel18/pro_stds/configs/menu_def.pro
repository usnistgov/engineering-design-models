...
@setbutton LAYERS Repaint \
"#View;#Repaint;#done-return;"\
"Repaint recently changed layers to update display."
...
@setbutton interface PLOT#A \
"#export;#plotter;#postscript;#plot;#a;#create;;#plot;#interface;"\
"Create A size postscript plot and send to printer."
