...
!========================================================== 
MAPKEY is #view;#names;#retrieve;#iso;#done-return; 
MAPKEY c1 #view;#names;#retrieve;#c1;#done-return; 
MAPKEY c2 #view;#names;#retrieve;#c2;#done-return; 
MAPKEY fl %f2;%qq;%f1;%f3;%f4; 

MAPKEY v1 #view;#cosmetic;#shade;#restore;v1;#Done-Return; 
MAPKEY v2 #view;#cosmetic;#shade;#restore;v2;#Done-Return; 
MAPKEY v3 #view;#cosmetic;#shade;#restore;v3;#Done-Return; 

MAPKEY f1 #view;#names;#retrieve;#final;#done-return; 
MAPKEY f2 #simplfd rep;#set current;#final;#done; 
MAPKEY f3 #mode;#Drawing;#search/retr;#/parts;#elevation.drw; 
MAPKEY f4 #mode;#Drawing;#search/retr;#/parts;#piping.drw; 
