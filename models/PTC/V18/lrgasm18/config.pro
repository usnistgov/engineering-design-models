...
MAPKEY sr #view;#cosmetic;#shade;#restore;shade;#done-return
MAPKEY sl #view;#cosmetic;#shade;#restore;layout;#done-return
MAPKEY sz #view;#cosmetic;#shade;#restore;zoom_in;#done-return
MAPKEY vv #view;#names;shade_iso
MAPKEY es #environment;#shading;#done-return
MAPKEY mp #sel by menu;#top_level_3d_layout.prt;#sel by menu;#name;#conv_angle_1
