...
MAPKEY bs #layer;#part;#sel by menu;#GEAR_SKELETON.PRT 
MAPKEY r1 #SHIFTER.ASM;#SHIFTER2.PRT;#done sel;#done;#dont update;#done;#enter 
MAPKEY rl #regenerate;#sel by menu;#GEAR_SKELETON.PRT;#sel by menu;%r1 
MAPKEY rd2 #id;7;#done;#done 
MAPKEY ref #set up;#ref dim;#show;#sel by menu;#FORK_2_H.PRT;%rd2 
MAPKEY xs #set up;#x-section;#A;#done/return 
MAPKEY es #environment;#shading;#done-return 
MAPKEY ye #yellow 
MAPKEY re #red 
mapkey lo #DONE/RETURN;#LAYER;#PART;#SEL BY MENU;#GEAR_SKELETON.PRT;\ 
mapkey(continued) #FORK_SURFS;#CURVES;#SHAFT_SRFS;#SRFS_GEAR;#DONE SEL;#DONE/RETURN;\ 
mapkey(continued) #DONE/RETURN;#VIEW;#REPAINT;#DONE-RETURN; 
mapkey si #ENVIRONMENT;#DISP DTMPLN;#DONE-RETURN;#SIMPLFD REP;\ 
mapkey(continued) #SET CURRENT;#INTERFERENCE;#DONE;#DONE/RETURN;#VIEW;#NAMES;#SHOW_SKEL;\ 
mapkey(continued) #DONE-RETURN; 
mapkey vk #VIEW;#NAMES;#SHOW_SKEL;#DONE-RETURN; 
mapkey vi #VIEW;#NAMES;#SIDE-ISO;#DONE-RETURN; 
mapkey la #QUIT WINDOW;#LAYOUT;#SEARCH/RETR;#gear_calc.lay;#RELATION;#SWITCH \ 
mapkey(continued) DIM; 
mapkey dm #RELATION;#SWITCH DIM 
mapkey rc #REGENERATE;#SEL BY MENU;#REV_GEAR_C.PRT;#DONE;#DONT UPDATE;#DONE;\ 
mapkey(continued) #CURRENT VALS 
mapkey vm #VIEW;#NAMES;#FIRST;#DONE-RETURN; 
mapkey go #SEC TOOLS;#SEC ENVIRON;#GRID;#GRID ON/OFF;#VIEW;#REPAINT;#SKETCH; 
mapkey box #VIEW;#COSMETIC;#SHADE;#RESTORE;box; 
mapkey cut #VIEW;#COSMETIC;#SHADE;#RESTORE;cut; 
mapkey iso #VIEW;#COSMETIC;#SHADE;#RESTORE;sde; 
mapkey dw #QUIT WINDOW;#DRAWING;#SEARCH/RETR;#shifter_assembly.drw; 
mapkey sh #QUIT WINDOW;#ASSEMBLY;#SEARCH/RETR;#shifter.asm; 
mapkey at #QUIT WINDOW;#ASSEMBLY;#SEARCH/RETR;#transmission.asm;#VIEW;#NAMES;\ 
mapkey(continued) #REVERSE;#DONE-RETURN; 
...
! 3___HOLE_AXES 
! 
! LAYER_DATUM 1_ALL_PLANES 
! LAYER_CSYS 2_ALL_CSYS 
!DEF_LAYER LAYER_AXIS 3_ALL_AXES 
! LAYER_POINT 4_ALL_POINTS 
! LAYER_CURVE 5_ALL_CURVES 
! LAYER_SURFACE 6_ALL_SURFS 
! LAYER_FEATURE 7_ALL_FEATURES 
! LAYER_DETAIL_ITEM 8_ALL_NOTES_BALLOONS_SYMBOLS_GTOLS(FREE) 
! 
